...
public class Compte {
	 ...
	 */
	public Compte(double solde_compte, String numero_compte, String type_compte, double taux_remuneration) {
		super();
	...
	public Compte(String type_compte, double taux_remuneration, double decouvert) {
		super();
		this.type_compte = type_compte;
		this.taux_remuneration = taux_remuneration;
		this.decouvert = decouvert;

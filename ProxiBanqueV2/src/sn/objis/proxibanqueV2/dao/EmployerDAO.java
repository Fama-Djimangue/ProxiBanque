...
public class EmployerDAO implements IEmployerDAO {
	...
	public void createConseiller(Employer conseiller, CompteUtilisateur compteConseiller,Employer gerant) {
		...
		try {
			...
			String sql = "INSERT INTO employer (nom_employer, prenom_employer, email_employer, adresse_employer,"
					...
					+ " id_gerant)  VALUES(?,?,?,?,?,?,?,'CCL','" + compteConseiller.getId_compte_user() + "','" + gerant.getId_employer() + "');";

	...
	<div class="container-fluid text-center">
		<div class="row content">
			...
			<div class="col-sm-10 text-left">
				<a href="<%=request.getContextPath()%>/gerant/creerConseiller.jsp"><button type="button" class="btn btn-sm btn-info"
								...
								<c:forEach var="conseiller" items="${conseillers}">
									<tr class="succes">
										...
										<td><button type="button" class="btn btn-danger"
											...
											<a
											href="ficheConseiller?idConseiller=${conseiller.id_employer}"><button type="button" class="btn btn-info" title="Modifier">
